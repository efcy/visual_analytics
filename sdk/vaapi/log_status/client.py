...
class LogStatusClient:
    ...
    def update(
        ...
        *,
        ...
        ball_model_frames: typing.Optional[int] = OMIT,
        camera_matrix_frames: typing.Optional[int] = OMIT,
        camera_matrix_top_frames: typing.Optional[int] = OMIT,
        field_percept_frames: typing.Optional[int] = OMIT,
        field_percept_top_frames: typing.Optional[int] = OMIT,
        goal_percept_frames: typing.Optional[int] = OMIT,
        goal_percept_top_frames: typing.Optional[int] = OMIT,
        ransacLine_percept_frames: typing.Optional[int] = OMIT,
        ransac_circle_percept_2018_frames: typing.Optional[int] = OMIT,
        shortLine_percept_frames: typing.Optional[int] = OMIT,
        scanLine_edgel_percept_frames: typing.Optional[int] = OMIT,
        scanLine_edgel_percept_top_frames: typing.Optional[int] = OMIT,
        odometry_data_frames: typing.Optional[int] = OMIT,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "log_id": log_id,
                "ball_model_frames": ball_model_frames,
                "camera_matrix_frames": camera_matrix_frames,
                "camera_matrix_top_frames": camera_matrix_top_frames,
                "field_percept_frames": field_percept_frames,
                "field_percept_top_frames": field_percept_top_frames,
                "goal_percept_frames": goal_percept_frames,
                "goal_percept_top_frames": goal_percept_top_frames,
                "ransacLine_percept_frames": ransacLine_percept_frames,
                "ransac_circle_percept_2018_frames": ransac_circle_percept_2018_frames,
                "shortLine_percept_frames": shortLine_percept_frames,
                "scanLine_edgel_percept_frames": scanLine_edgel_percept_frames,
                "scanLine_edgel_percept_top_frames": scanLine_edgel_percept_top_frames,
                "odometry_data_frames": odometry_data_frames,
