...
class AnnotationClient:
    ...
    def get(self, id: int, *, request_options: typing.Optional[RequestOptions] = None) -> Annotation:
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"api/annotation/{jsonable_encoder(id)}/", method="GET", request_options=request_options
        )
        try:
    ...
    def list(
            ...
            #log_id: int, *, 
            request_options: typing.Optional[RequestOptions] = None,
            **filters: typing.Any) -> typing.List[Annotation]:
        """
        List all logs.
    ...
    def bulk_create(
        self,
        *,
        repr_list: typing.List[Annotation] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> Annotation:
        """
        Examples
