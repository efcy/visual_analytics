...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="ransaccirclepercept2018",
                to="cognition.cognitionframe",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="ransaclinepercept",
                to="cognition.cognitionframe",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="scanlineedgelpercept",
                to="cognition.cognitionframe",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="scanlineedgelpercepttop",
                to="cognition.cognitionframe",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["log", "frame_number"], name="cognition_c_log_id_612691_idx"
            ),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("frame",), name="unique_frame_id_ballmodel"
            ),
        ),
        migrations.AddConstraint(
