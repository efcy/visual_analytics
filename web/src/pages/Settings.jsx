            ...
            <CardContent>
              <div className="p-0">
                <div className="flex items-center mb-4">
                  <Label htmlFor="username" className="w-24 mr-4 text-right">
                    Username
                  </Label>
                  <Input
                ...
                <div className="flex items-center mb-4">
                  <Label htmlFor="email" className="w-24 mr-4 text-right">
                    Email
                  </Label>
                  <Input
                    placeholder="Email"
                ...
                <div className="flex items-center mb-4">
                  <Label htmlFor="name" className="w-24 mr-4 text-right">
                    First Name
                  </Label>
                  <Input
                ...
                <div className="flex items-center mb-4">
                  <Label htmlFor="surname" className="w-24 mr-4 text-right">
                    Last Name
                  </Label>
                  <Input
          ...
          <Card>
            ...
            <CardContent>
              <form className="flex flex-col gap-4">
                <Input disabled defaultValue={token} />
